...
const AddExpenseModal: React.FC<AddExpenseModalProps> = ({
  ...
  const handleReceiptScanned = (expense: Omit<Expense, 'id'>) => {
    ...
    if (expense.receiptImageBase64) {
      setReceiptPreview(`data:image/jpeg;base64,${expense.receiptImageBase64}`);
    }
    
    toast.success('Receipt data extracted and populated!');
  };
          ...
          {!initialData && (
            <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
              ...
              <p className="text-xs text-blue-600 dark:text-blue-400 mt-2">
                Automatically extract merchant, amount, date, and category from your receipt image
              </p>
            </div>
          )}
