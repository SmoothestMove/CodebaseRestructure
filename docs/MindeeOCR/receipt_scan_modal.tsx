...
const ReceiptScanModal: React.FC<ReceiptScanModalProps> = ({
  ...
  const renderUploadStep = () => (
    <div className="text-center">
      <div
        className="border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-lg p-8 mb-4 hover:border-brand-primary dark:hover:border-brand-primary transition-colors cursor-pointer"
        onDrop={handleDrop}
      ...
      >
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <div className="flex items-center gap-2 px-4 py-2 bg-brand-primary text-white rounded-lg hover:bg-brand-primary/90 transition-colors">
