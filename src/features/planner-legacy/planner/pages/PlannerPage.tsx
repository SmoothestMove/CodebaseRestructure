  ...
  return (
    ...
    >
      <div className="min-h-screen bg-slate-50 dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-800">
        {/* Header */}
        <div className="bg-white dark:bg-slate-800/90 backdrop-blur-sm shadow-sm border-b border-slate-200 dark:border-slate-700/50">
        ...
        <div className="flex h-[calc(100vh-10rem)] md:h-[calc(100vh-8rem)]">
          ...
          <div className={`
            ...
            overflow-x-auto bg-slate-50 dark:bg-transparent
          `}>
