...
type ToastProps = ComponentPropsWithoutRef<typeof ToastPrimitives.Root> & VariantProps<typeof toastVariants>;

type ToastRef = ElementRef<typeof ToastPrimitives.Root>;

const Toast = forwardRef<ToastRef, ToastProps>(({ className, variant, ...props }, ref) => {
