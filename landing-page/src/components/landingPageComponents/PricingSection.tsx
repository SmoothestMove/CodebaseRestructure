        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-7 my-4 md:my-12 text-[#293A51]">
          <div className="bg-white p-8 rounded-xl shadow-sm mt-10 border border-slate-100 flex flex-col h-full">
            ...
            <p className="font-bold mb-6 text-center text-slate-700">
              ...
              <span className="text-xs text-[#6B7989]">/ during waitlist</span>
            </p>
            ...
            <p className="font-medium mt-6 mb-4 text-slate-700">Included in beta</p>
          ...
          <div className="relative bg-white p-4 md:p-8 rounded-xl shadow-md border-2 md:border-4 border-slate-900 flex flex-col h-full">
            ...
            <p className="font-bold mb-6 text-center text-slate-700">
              <span className="text-4xl">Pricing TBD</span>
              <span className="text-xs text-[#6B7989]"> / post-launch</span>
            </p>
            ...
            <p className="font-medium mb-4 text-slate-700">Planned upgrades</p>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm mt-10 border border-slate-100 flex flex-col h-full">
            ...
            <p className="font-medium mt-6 mb-4 text-slate-700">Exploring with partners</p>
