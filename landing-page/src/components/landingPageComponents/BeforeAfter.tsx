      ...
      <MaxWidthWrapper className="pb-10 pt-20">
        <div className="max-w-3xl mx-auto tracking-tight flex flex-col items-center justify-center gap-5 text-slate-800 dark:text-slate-100">
          <div className="flex items-center justify-center gap-1.5">
            ...
            <h2 className="font-bold text-xl md:text-3xl text-center">Still juggling spreadsheets, texts, and sticky notes?</h2>
          </div>

          <div className="flex items-center justify-center gap-1.5">
            <Check className="w-8 h-8 sm:w-6 sm:h-6 text-emerald-600" />
            <h2 className="font-bold text-xl md:text-3xl text-center text-balance">Smooth Moves keeps every detail in one guided workspace.</h2>
          </div>
        </div>
